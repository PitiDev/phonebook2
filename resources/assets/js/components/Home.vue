<template>
	...
	<nav class="panel column is-offset-2 is-8-desktop is-12-mobile is-primary" >
	  <p class="panel-heading">
	    <b>ບັນທືກລາຍຊື່</b>
	     <a href="#" class="button is-success is-outlined" id="right" @click="openAdd">ເພີ່ມລາຍຊື່ໃໝ່</a>
